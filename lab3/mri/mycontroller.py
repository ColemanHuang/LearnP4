...
def writeForwardRules(p4info_helper, ingress_sw, dst_eth_addr,
    ...
    table_entry = p4info_helper.buildTableEntry(
        ...
        match_fields={
            "hdr.ipv4.dstAddr": (dst_ip_addr, match)
        },
